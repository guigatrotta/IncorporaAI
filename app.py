...
pasta_imoveis_file = st.file_uploader("IMÓVEIS - Selecione a pasta para armazenar a planilha:", type=["*"], key="pasta_imoveis")
pasta_guias_file = st.file_uploader("GUIA AMARELA - Selecione a pasta para armazenar os PDFs:", type=["*"], key="pasta_guias")
csv_file = st.file_uploader("ENDEREÇOS GUIA AMARELA - Selecionar Pasta para o arquivo CSV:", type=["csv"], key="csv")
